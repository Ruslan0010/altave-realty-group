...
export const metadata: Metadata = {
  ...
  description:
    'Altave Realty Group — premium full-service real estate in New York City. Luxury rentals, sales, and commercial properties across Manhattan, Brooklyn, Queens, and beyond.',
  keywords: [
    'NYC real estate',
    'luxury apartments',
    'Manhattan rentals',
  ...
  openGraph: {
    ...
    description:
      'Premium full-service real estate in New York City. Luxury rentals, sales, and commercial properties.',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'Altave Realty Group' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Altave Realty Group | Elevate Your Space',
    description: 'Premium full-service real estate in New York City.',
    images: ['/og-image.jpg'],
  },
